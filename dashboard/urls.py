...
from .views import (
    ...
    receptionist_dentist_availability_page,
...
urlpatterns = [
    ...
    path("receptionist/dentist-availability/", receptionist_dentist_availability_page, name="receptionist_dentist_availability"),
